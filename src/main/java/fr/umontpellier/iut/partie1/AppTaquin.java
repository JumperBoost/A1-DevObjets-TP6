...
public class AppTaquin {
    public static void main(String[] args) {
        ...
        // Taquin résolvable en 7 pas
        Taquin taquin_contexte = new Taquin(new int[][]{{5, 0, 2}, {1, 4, 3}, {7, 8, 6}});
        Contexte contexte = new Contexte(taquin_contexte);
        contexte.resoudre();
        System.out.println("Il y a " + (contexte.getDistance()) + " pas pour résoudre ce contexte.");
