...
9. **Bonus** : On peut remarquer que le test d'appartenance d'une nouvelle fille à l'ensemble `dejaVus` n'est pas utile. En effet, les grilles générées (à n'importe quelle étape) sont toutes différentes entre elles. Démontrer cette propriété par récurrence. Comment modifier votre programme pour pouvoir prendre en compte cette remarque ?